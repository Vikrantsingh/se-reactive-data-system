...
public class FunctionReaction extends Reaction {
	...
	public void registerReaction(int event_id,String reaction_name,String function_name)
	{
		setEvent_id(event_id);
		setFunction_name(function_name);		
		setReaction_name(reaction_name);
		setReaction_type("FUNCTION");
		setSql_query("");		
	}
	...
	public void save() {
		...
		try {
			...
			if (rs.next()) {
				...
				System.out.println("inserted in functionReaction" + getReaction_id());
			} else {
