...
public class SignUp {
	...
	public static void mailConformation(int thedigest)
	{
		...
		try
		{
			...
			message.setText(" Please Click Here to Activate your account or copy paste this url http://192.16.12.66:8080/universal_admissions/activate.jsp?user_id="+thedigest);
