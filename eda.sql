...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 20, 2013 at 07:32 AM
...
--
-- Table structure for table `db_reaction`
--

CREATE TABLE IF NOT EXISTS `db_reaction` (
  `DB_actionID` int(11) NOT NULL,
  `DB_name` varchar(100) NOT NULL,
  `DB_query` varchar(500) NOT NULL,
  `actionID` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`DB_actionID`),
  UNIQUE KEY `DB_actionID_UNIQUE` (`DB_actionID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
