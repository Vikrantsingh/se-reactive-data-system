...
public class TimeEventsRegister extends Events {
    ...
    public void register_Event(String event_name, String time, int parameter) {
    ...
    public void save() {
        ...
        try {
             ...
             * Store in db_event
             */
            query = "insert into time_event (event_id,time,parameter) values (?,?,?)";
    ...
    public static void main(String[] args) {
        ...
        time.register_Event("hellotime", "2013/04/03 01:50:00", 6);//yyyy/MM/dd HH:mm:ss
        time.save();
        
        FunctionReaction fr = new FunctionReaction();
        
        fr.registerReaction(time.getEvent_id(), "seatAllocate", "app.admission.seatAllocation.PreferencesAction.allocateSeat");
