                    ...
                    <div id="content-in">
                        ...
                        <%
                            ...
                            try {
                                ...
                                String sql = "select DISTINCT(group_id),title,description,group_payment_id,payment_status,application_status,fill_preferences from view_group_details where applicant_id=" + Integer.parseInt(session.getAttribute("id").toString());
                            ...
                            <table class="nomb table-style01">
                                ...
                                <tr>
                                    ...
                                    <td colspan='2' align='center'>
                                        ...
                                        <%
                                            if (r.getString("application_status").equals("approved") && r.getInt("fill_preferences") == 1) {
                                        %>
                                        <a href="student_preferences.jsp?group_id=<%=r.getInt("group_id")%>"><button type="button" class="btn btn-primary">
                                            ...
                                            <%
                                                    ...
                                                    if (r.getInt("fill_preferences") == 0) {
                                                        out.print("Suspended");
                                                    } else {
                                    ...
                                    <td colspan='2' align='center'>
                                        ...
                                        <a href="view_status.jsp"><button type="button" class="btn btn-primary">
