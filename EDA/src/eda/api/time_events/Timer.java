         ...
         //   System.out.println("hello");
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    System.out.println("Time event detected");    
                    
                    //Execute Function
                    
                    System.out.println(rs.getString("function_name"));
                    CallerUnit cu = new CallerUnit();
                    cu.callFunction(rs.getString("function_name"), rs.getInt("parameter"));
